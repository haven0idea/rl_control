...
from legged_gym.envs.irmv2.irmv2_config import IRMV2RoughCfg, IRMV2RoughCfgPPO
from legged_gym.envs.irmv2.irmv2_env import IRMV2Robot
...
task_registry.register( "irmv2", IRMV2Robot, IRMV2RoughCfg(), IRMV2RoughCfgPPO())
